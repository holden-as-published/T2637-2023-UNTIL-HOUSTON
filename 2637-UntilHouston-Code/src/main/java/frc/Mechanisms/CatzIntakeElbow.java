...
public class CatzIntakeElbow extends AbstractMechanism
{
    ...
    public enum ElbowPosID
    {
        ...
        private ElbowPosID(double angle, String name)
        {
            this.angle = angle;
            this.name = name;
        }
    ...
    public volatile ElbowPosID targetPos = ElbowPosID.STW;
    public ElbowPosID currentPos = ElbowPosID.NON;
    ...
    {
        SmartDashboard.putString("Intake Elbow Current Position", currentPos.name);
    }
    
    @Override
    public void smartDashboard_DEBUG()
    {
        SmartDashboard.putString("Intake Elbow Target Position", targetPos.name);
        SmartDashboard.putNumber("Intake Elbow Encoder", currentPositionEnc);
